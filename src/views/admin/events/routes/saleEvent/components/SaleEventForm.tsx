...
import { NewSaleEventForm } from "../SaleEvent";
...
interface SaleEventFormProps {
  useFormInstance: UseFormReturn<NewSaleEventForm, any, undefined>;
}
...
function SaleEventForm(props: SaleEventFormProps) {
  ...
  useEffect(() => {
    ...
    setValue("quantity", undefined); // Reset quantity when cage changes
  ...
  return (
    <SimpleGrid columns={1} spacing={5}>
      ...
      <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={5}>
      <FormControl isRequired={true}>
          <FormLabel>Peso unitario</FormLabel>
          <Controller
            name="unit_weight"
            control={control}
            rules={{
