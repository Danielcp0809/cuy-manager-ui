...
import { NewHealthEventForm } from "../HealthEvent";
...
interface HealthEventFormProps {
  useFormInstance: UseFormReturn<NewHealthEventForm, any, undefined>;
}

function HealthEventForm(props: HealthEventFormProps) {
