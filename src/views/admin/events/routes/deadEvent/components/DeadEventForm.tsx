...
import { NewDeadEventForm } from "../DeadEvent";
...
interface DeadEventFormProps {
  useFormInstance: UseFormReturn<NewDeadEventForm, any, undefined>;
}
...
function DeadEventForm(props: DeadEventFormProps) {
